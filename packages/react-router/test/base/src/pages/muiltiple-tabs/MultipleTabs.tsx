  ...
  return (
    <IonSplitPane contentId="main">
      ...
      <IonRouterOutlet id="main">
        ...
        <Route
          path="/multiple-tabs"
          element={<Navigate to="/multiple-tabs/tab1" />}
        />
      </IonRouterOutlet>
    </IonSplitPane>
  );
  ...
  return (
    <IonTabs>
      ...
      <IonRouterOutlet id="tab1">
        <Route
          path="/multiple-tabs/tab1"
          element={<Navigate to="/multiple-tabs/tab1/pagea" />}
        />
        {/* <Navigate path="/multiple-tabs/event" to="/multiple-tabs/tab1/pagea" /> */}
  ...
  return (
    <IonTabs>
      ...
      <IonRouterOutlet id="tab2">
        <Route
          path="/multiple-tabs/tab2"
          element={<Navigate to="/multiple-tabs/tab2/pagec" />}
        />
        {/* <Navigate path="/multiple-tabs/tab2" to="/multiple-tabs/tab2/pagec" /> */}
